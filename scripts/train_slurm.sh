...
CUDA_LAUNCH_BLOCKING=1 srun python /home/rohitram/scratch/Key-Actor-Detection/run.py /home/rohitram/scratch/Key-Actor-Detection/configs/sbu.yaml "dataset_path=$SLURM_TMPDIR/sbu_dataset" "training.save_dir=$SLURM_TMPDIR/mlruns" 
